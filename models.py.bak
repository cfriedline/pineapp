...
class EnvdataPopulation(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    ...
    class Meta:
        managed = False
        db_table = 'envdata_population'


class EnvdataSample(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    population = models.ForeignKey(EnvdataPopulation, blank=True, null=True)
    name = models.CharField(unique=True, max_length=20)
